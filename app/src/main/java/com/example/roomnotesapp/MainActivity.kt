...
import com.example.roomnotesapp.data.AppDatabase
import com.example.roomnotesapp.data.Note
import com.example.roomnotesapp.data.NoteRepository
import com.example.roomnotesapp.ui.theme.RoomNotesAppTheme
import com.example.roomnotesapp.viewmodel.NoteViewModel
import com.example.roomnotesapp.viewmodel.NoteViewModelFactory
...
fun NoteScreen(vm: NoteViewModel) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        Text("List Notes", style = MaterialTheme.typography.headlineSmall)
